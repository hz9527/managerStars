...
// 客户端来判断数据是否为空
// tips {userName: [{id: xx, name: xx}]} 暂不支持多用户
// 暂不支持逻辑删除
// 获取用户信息
...
// 添加tip query {userName: xx} data {name: xx}
...
// 编辑tip query {userName: xx} data {id: xx, name: xx}
